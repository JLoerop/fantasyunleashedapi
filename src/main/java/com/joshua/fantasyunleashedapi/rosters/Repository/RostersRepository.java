...
public interface RostersRepository extends JpaRepository<Rosters, Integer> {
    ...
    @Query(value = "UPDATE rosters r SET " +
            ...
            "WHERE :playerId IN (qb_player_id, rb1_player_id, rb2_player_id, wr1_player_id, wr2_player_id, flex_player_id, kicker_player_id, def_player_id, bench1, bench2, bench3, bench4)",
            nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM rosters WHERE " +
            ...
            "wr1_player_id = :playerId OR wr2_player_id = :playerId OR flex_player_id = :playerId OR " +
